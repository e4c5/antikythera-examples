 ...
 * 
 * <p>
 * Spring Boot 2.4 moved R2DBC infrastructure from Spring Boot to Spring Framework 5.3.
 ...
 * <li>Most imports should remain compatible: {@code org.springframework.r2dbc.core.DatabaseClient}</li>
 * </ul>
 * 
 * @see MigrationPhase
 */
public class R2dbcCodeMigrator implements MigrationPhase {
    private static final Logger logger = LoggerFactory.getLogger(R2dbcCodeMigrator.class);
