 ...
 * <ul>
 * <li><b>CRITICAL</b>: Configuration file processing overhauled - profile syntax changed</li>
 * <li><b>CRITICAL</b>: data.sql processing timing changed (requires defer-datasource-initialization)</li>
 * <li>Neo4j property namespace changed from spring.data.neo4j.* to spring.neo4j.*</li>
...
public class SpringBoot23to24Migrator extends AbstractSpringBootMigrator {
     ...
     * 
     * <pre>
     * java com.raditha.spring.SpringBoot23to24Migrator [--dry-run] 
     *      [--project-path &lt;path&gt;]
     * </pre>
     */
    public static void main(String[] args) throws Exception {
        ...
        // Run migration
        SpringBoot23to24Migrator migrator = new SpringBoot23to24Migrator(dryRun);
    ...
    private static void printUsageAndExit() {
        System.out.println("Usage: java com.raditha.spring.SpringBoot23to24Migrator [OPTIONS]");
        System.out.println();
        ...
        System.out.println(
                "  java com.raditha.spring.SpringBoot23to24Migrator --dry-run --project-path /path/to/project");
        System.exit(1);
    }
}
