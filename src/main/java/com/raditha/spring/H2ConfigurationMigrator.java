...
public class H2ConfigurationMigrator extends AbstractConfigMigrator {
    ...
    private Map<String, Boolean> checkYamlFile(Path yamlFile) throws IOException {
    ...
    private Map<String, Boolean> checkPropertiesFile(Path propFile) throws IOException {
        boolean h2Enabled = false;
        boolean datasourceConfigured = false;
