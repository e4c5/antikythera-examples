...
class GeminiAIServiceConfigTest {
    ...
    @Test
    void testGetConfigString_ConfigValueEmpty() throws Exception {
    ...
    @Test
    void testGetConfigString_ConfigValueWhitespace() throws Exception {
    ...
    @Test
    void testGetConfigString_ApiKeyFromEnv() throws Exception {
    ...
    @Test
    void testGetConfigString_ApiEndpointFromEnv() throws Exception {
    ...
    @Test
    void testGetConfigString_OtherKeyNoEnvFallback() throws Exception {
    ...
    @Test
    void testGetConfigString_EnvVarEmpty() throws Exception {
    ...
    @Test
    void testGetConfigString_EnvVarWhitespace() throws Exception {
    ...
    @Test
    void testGetConfigString_ConfigPrecedenceOverEnv() throws Exception {
