...
## 2026-01-04 - Exception Handling
**Pattern:** Prefer propagating exceptions (fail fast) over catching and rethrowing as RuntimeExceptions, especially when the caller already handles the checked exception.
**Learning:** This simplifies the code and preserves the original exception type, making it easier for callers to handle specific error conditions.
